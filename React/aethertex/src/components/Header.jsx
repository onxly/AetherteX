...
function Header() {
  const { isLoggedIn, logout, user, cart = [] } = useContext(AuthContext);
            ...
            <div className="AccModel">
              <div className="AccContent">
                ...
                <div className="HeadAccDet">
                  {user?.IsPremium ? (
                    <h2>
                      <FaCrown width={20} height={20} color="gold" /> &nbsp;
                      {user?.username} <em className="IsPrem">(Premium)</em>
                    </h2>
                  ) : (
                    <h2>
                      <FaUser
